...
long long GetWordHash(char* word) {
    return FastTextHash(word) % bucket_size;
}

// vocab 해시 계산용 (vocab_hash_size는 30000000으로 정의됨)
int GetHash(char* word) {
    return FastTextHash(word) % vocab_hash_size;
}
...
int main(int argc, char** argv)
{
    ...
    strcpy(output_file, "./result/ar/arvec_finaltest2.bin");
    strcpy(save_model_file, "./result/ar/armodel_finaltest1.bin");
#endif
    debug_mode = 0;
